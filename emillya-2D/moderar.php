...
if(isset($_POST['atualiza'])){
    ...
    $sql = "UPDATE usuarios SET nome='$nome', email='$email', mensagem='$mensagem' WHERE id=$idatualiza";
...
<?php if($usuarios_editar): ?>
<div id="formulario_mural">
<form method="post">
    <label>Nome:</label>
    <input type="text" name="nome" value="<?php echo htmlspecialchars($usuarios_editar['nome']); ?>"/><br/>
    <label>Email:</label>
    <input type="text" name="email" value="<?php echo htmlspecialchars($usuarios_editar['email']); ?>"/><br/>
    <label>Mensagem:</label>
    <textarea name="mensagem"><?php echo htmlspecialchars($usuarios_editar['mensagem']); ?></textarea><br/>
    <input type="hidden" name="id" value="<?php echo $usuarios_editar['id']; ?>"/>
    <input type="submit" name="atualiza" value="Modificar usuarios" class="btn"/>
</form>
</div>
<?php endif; ?>
